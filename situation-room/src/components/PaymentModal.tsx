      ...
      <div className="animate-pop-in" style={{ 
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:'12px' }}>
          {isCounter ? (
            <>
              <button
                onClick={() => handlePay('실물카드')}
                disabled={isSubmitting}
                style={{ 
                  display:'flex', alignItems:'center', gap:'16px', padding:'14px 18px',
                  borderRadius:'14px', border:'none', background: 'var(--primary)',
                  color: 'white', textAlign:'left', cursor: isSubmitting ? 'not-allowed' : 'pointer', 
                  boxShadow:'0 6px 15px rgba(30, 41, 59, 0.12)', transition:'all 0.15s',
                }}
              >
                <span style={{ fontSize:'1.8rem' }}>💳</span>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:800, fontSize:'1.05rem' }}>실물카드 결제 (NFC 태깅)</div>
                  <div style={{ color:'rgba(255,255,255,0.8)', fontSize:'0.72rem', marginTop:'2px' }}>
                    실물 카드를 스마트폰 뒷면에 대고 결제 (페이앱)
                  </div>
                </div>
              </button>
              ...
              <button
                ...
                style={{ 
                  display:'flex', alignItems:'center', gap:'16px', padding:'14px 18px',
                  borderRadius:'14px', border:'1px solid var(--border)', background: '#fee500',
              ...
              >
                <span style={{ fontSize:'1.8rem' }}>💛</span>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:800, fontSize:'1.05rem', color: '#3c1e1e' }}>카카오페이 (QR/바코드 스캔)</div>
                  <div style={{ color:'rgba(60,30,30,0.8)', fontSize:'0.72rem', marginTop:'2px' }}>
                    고객의 카카오페이 QR/바코드를 카메라로 스캔
                  </div>
                </div>
              </button>

              <button
                onClick={() => handlePay('네이버페이')}
                disabled={isSubmitting}
                style={{ 
                  display:'flex', alignItems:'center', gap:'16px', padding:'14px 18px',
                  borderRadius:'14px', border:'1px solid var(--border)', background: '#03c75a',
                  color: 'white', textAlign:'left', cursor: isSubmitting ? 'not-allowed' : 'pointer', 
                  transition:'all 0.15s',
                }}
              >
                <span style={{ fontSize:'1.8rem' }}>💚</span>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:800, fontSize:'1.05rem' }}>네이버페이 (QR/바코드 스캔)</div>
                  <div style={{ color:'rgba(255,255,255,0.8)', fontSize:'0.72rem', marginTop:'2px' }}>
                    고객의 네이버페이 QR/바코드를 카메라로 스캔
                  </div>
                </div>
              </button>

              <button
                onClick={() => handlePay('폰 to 폰 결제')}
                disabled={isSubmitting}
                style={{ 
                  display:'flex', alignItems:'center', gap:'16px', padding:'14px 18px',
                  borderRadius:'14px', border:'1px solid var(--border)', background: 'transparent',
              ...
              >
                <span style={{ fontSize:'1.8rem' }}>📲</span>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:800, fontSize:'1.05rem' }}>원격 폰 to 폰 결제</div>
                  <div style={{ color:'var(--text-muted)', fontSize:'0.72rem', marginTop:'2px' }}>
                    고객의 스마트폰 화면으로 결제 요청을 직접 전송
                  </div>
                </div>
              </button>

              <button
                onClick={() => handlePay('현금/후불')}
                disabled={isSubmitting}
                style={{ 
                  display:'flex', alignItems:'center', gap:'16px', padding:'14px 18px',
                  borderRadius:'14px', border:'1px solid var(--border)', background: 'transparent',
              ...
              >
                <span style={{ fontSize:'1.8rem' }}>💵</span>
                <div style={{ flex:1 }}>
                  <div style={{ fontWeight:800, fontSize:'1.05rem' }}>현금 및 기타 수동 정산</div>
                  <div style={{ color:'var(--text-muted)', fontSize:'0.72rem', marginTop:'2px' }}>
                    PG창 호출 없이 장부상 결제 완료 및 세션 종료
                  </div>
                </div>
              </button>
            </>
